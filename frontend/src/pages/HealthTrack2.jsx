...
const HealthTrack2 = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-r from-blue-50 to-blue-100 flex flex-col justify-center items-center p-4">
      <h2 className="text-3xl font-bold mb-6 text-blue-900 text-center">Hen's Daily Data Track</h2>
          ...
          <table className="w-full border-collapse text-sm sm:text-base">
            <thead>
              <tr>
                ...
                <th className="border border-gray-300 text-left px-4 py-2 bg-blue-500 text-white">Egg Production</th>
